...
KURALLAR: list[tuple[list[str], str, str, str, str]] = [
    ...
    (["brugge","oud|jong|extra|belge"],"D01","Peynir","Belçika Peynirleri","Brugge Peyniri"),
    (["brugge"],                    "D01","Peynir","Belçika Peynirleri","Brugge Peyniri"),
    (["flandrien"],                 "D01","Peynir","Belçika Peynirleri","Flandrien"),
    (["maredsous"],                 "D01","Peynir","Belçika Peynirleri","Maredsous"),
    (["grimbergen","kaas|kubus|blok"],"D01","Peynir","Belçika Peynirleri","Grimbergen Peyniri"),
    (["pas de rouge"],              "D01","Peynir","Belçika Peynirleri","Pas de Rouge"),
    (["wijnendale"],                "D01","Peynir","Belçika Peynirleri","Wijnendale"),
    (["rubens"],                    "D01","Peynir","Belçika Peynirleri","Rubens"),
    # Yumuşak & taze peynir
    ...
    (["ricotta"],                   "D01","Peynir","Yumuşak & Taze Peynir","Ricotta"),
    (["mascarpone"],                "D01","Peynir","Yumuşak & Taze Peynir","Mascarpone"),
    (["philadelphia"],              "D01","Peynir","Yumuşak & Taze Peynir","Cream Cheese"),
    (["boursin"],                   "D01","Peynir","Yumuşak & Taze Peynir","Boursin"),
    (["chavroux|chèvre|chevre"],    "D01","Peynir","Yumuşak & Taze Peynir","Keçi Peyniri"),
    (["roomkaas|cream cheese"],     "D01","Peynir","Yumuşak & Taze Peynir","Cream Cheese"),
    (["verse kaas|verse fromage|fromage frais"],"D01","Peynir","Yumuşak & Taze Peynir",""),
    # Sert peynir
    ...
    (["edammer|edam"],              "D01","Peynir","Sert Peynir","Edam"),
    (["maasdam"],                   "D01","Peynir","Sert Peynir","Maasdam"),
    (["leerdammer"],                "D01","Peynir","Sert Peynir","Leerdammer"),
    (["jarlsberg"],                 "D01","Peynir","Sert Peynir","Jarlsberg"),
    (["raclette"],                  "D01","Peynir","Sert Peynir","Raclette"),
    (["gruyère|gruyere|gruyère"],   "D01","Peynir","Sert Peynir","Gruyère"),
    (["comté|comte"],               "D01","Peynir","Sert Peynir","Comté"),
    (["manchego"],                  "D01","Peynir","Sert Peynir","Manchego"),
    (["pecorino"],                  "D01","Peynir","Sert Peynir","Pecorino"),
    # Eritme peyniri / smeltkaas
    (["la vache qui rit|laughing cow"],"D01","Peynir","Eritme Peyniri","La Vache Qui Rit"),
    (["smeltkaas|smeltk|gesmolten"],  "D01","Peynir","Eritme Peyniri",""),
    # Mavi peynir
    (["bleu|blauw|blue","kaas|fromage|cheese|gorgonzola|roquefort"],"D01","Peynir","Mavi Peynir",""),
    (["gorgonzola"],                "D01","Peynir","Mavi Peynir","Gorgonzola"),
    (["roquefort"],                 "D01","Peynir","Mavi Peynir","Roquefort"),
    # Genel kaas keyword (en sona)
    ...
    (["biologische eieren|bio eieren|oeufs bio"],"D01","Yumurta","Tavuk Yumurtası","Organik Yumurta"),
    (["vrije uitloop|plein air|free range"],"D01","Yumurta","Tavuk Yumurtası","Serbest Gezen Yumurta"),
    (["scharreleieren|oeufs de plein air|barn"],"D01","Yumurta","Tavuk Yumurtası","Ahır Yumurtası"),
    (["kwarteleieren|oeufs de caille"],"D01","Yumurta","Tavuk Yumurtası","Bıldırcın Yumurtası"),
    ...
    (["rijstmelk|lait de riz|rice milk"],"D01","Süt & Süt Alternatifleri","Bitki Bazlı Süt","Pirinç Sütü"),
    (["kokosmelk|lait de coco|coconut milk"],"D01","Süt & Süt Alternatifleri","Bitki Bazlı Süt","Hindistan Cevizi Sütü"),
    (["lactosevrij|sans lactose|lactose free","melk|lait|milk"],"D01","Süt & Süt Alternatifleri","İnek Sütü","Laktozsuz Süt"),
    (["uht","melk|lait|milk"],"D01","Süt & Süt Alternatifleri","İnek Sütü","UHT Süt"),
    (["biologisch|bio","melk|lait|milk"],"D01","Süt & Süt Alternatifleri","İnek Sütü","Organik Süt"),
    (["volle melk|lait entier|full fat milk"],"D01","Süt & Süt Alternatifleri","İnek Sütü","Tam Yağlı Süt"),
    (["halfvolle melk|demi-écrémé|semi-skimmed"],"D01","Süt & Süt Alternatifleri","İnek Sütü","Yarım Yağlı Süt"),
    (["magere melk|écrémé|skimmed|afgeroomde"],"D01","Süt & Süt Alternatifleri","İnek Sütü","Yağsız Süt"),
    (["melkpoeder|lait en poudre|milk powder"],"D01","Süt & Süt Alternatifleri","İnek Sütü","Süt Tozu"),
...
CATEGORY_NAME_MAP: list[tuple[list[str], str, str, str, str]] = [
    ...
    # ── Colruyt topCategoryName (API'den gelen gerçek değerler) ─────────────
    # Peynir alt-kategorileri — Zuivel içinde olsa da önce bunlara bak
    (["verse kazen"],            "D01","Peynir","Yumuşak & Taze Peynir",""),
    (["harde kazen"],            "D01","Peynir","Sert Peynir",""),
    (["gesmolten kazen"],        "D01","Peynir","Eritme Peyniri",""),
    (["zachte kazen"],           "D01","Peynir","Yumuşak & Taze Peynir",""),
    (["blauwe kazen"],           "D01","Peynir","Mavi Peynir",""),
    (["kaas","verse"],           "D01","Peynir","Yumuşak & Taze Peynir",""),
    (["kaas"],                   "D01","Peynir","Sert Peynir",""),
    # Süt alt-kategorileri
    (["verse melk","halfvol|vol|mager"],"D01","Süt & Süt Alternatifleri","İnek Sütü",""),
    (["plantaardige melk|dranken"],"D01","Süt & Süt Alternatifleri","Bitki Bazlı Süt",""),
    (["yoghurt","drink"],        "D01","Yoğurt & Fermente","Fermente İçecekler",""),
    (["yoghurt"],                "D01","Yoğurt & Fermente","Yoğurt",""),
    (["boter","margarine"],      "D01","Tereyağı & Yağlar","Tereyağı",""),
    (["room","crème"],           "D01","Krema & Tatlı Süt Ürünleri","Krema",""),
    (["dessert","pudding"],      "D01","Krema & Tatlı Süt Ürünleri","Tatlı",""),
    (["eieren"],                 "D01","Yumurta","Tavuk Yumurtası",""),
    # Zuivel son gelir — keyword veya alt-kategori yoksa süte düşsün
    ...
    (["beenhouwerij"],           "D02","Sığır Eti","Taze Sığır",""),
    (["vleeswaren"],             "D02","Domuz Eti","Şarküteri",""),
    (["vlees"],                  "D02","Sığır Eti","Taze Sığır",""),
    (["bereidingen","vis"],      "D02","Balık & Deniz Ürünleri","Taze & Soğutmalı Balık",""),
    (["vis"],                    "D02","Balık & Deniz Ürünleri","Taze & Soğutmalı Balık",""),
    (["gevogelte"],              "D02","Kümes Hayvanları","Tavuk",""),
    (["charcuterie"],            "D02","Domuz Eti","Şarküteri",""),
    # ── Meyve & Sebze ───────────────────────────────────────────────────────
    (["groenten en fruit"],      "D03","Taze Sebze","Yapraklı Sebze",""),
    (["verse groenten"],         "D03","Taze Sebze","Yapraklı Sebze",""),
    (["vers fruit"],             "D03","Taze Meyve","Mevsim Meyveleri",""),
    (["groenten"],               "D03","Taze Sebze","Yapraklı Sebze",""),
    (["fruit"],                  "D03","Taze Meyve","Mevsim Meyveleri",""),
    # ── Ekmek & Fırın ────────────────────────────────────────────────────────
    (["brood","bakkerij"],       "D04","Ekmek","Beyaz Ekmek",""),
    (["bakkerij"],               "D04","Belçika Fırın","Pistolet & Brioche",""),
    (["brood"],                  "D04","Ekmek","Beyaz Ekmek",""),
    # ── Temel Bakkaliye ──────────────────────────────────────────────────────
    (["kruidenierswaren","droge voeding"], "D05","Tahıl & Makarna","Makarna",""),
    (["pasta","rijst"],          "D05","Tahıl & Makarna","Makarna",""),
    (["rijst","pasta"],          "D05","Tahıl & Makarna","Pirinç",""),
    ...
    (["conserven"],              "D05","Konserve & Kavanoz","Domates Konserve",""),
    (["olie"],                   "D05","Yağ & Sos","Bitkisel Yağlar",""),
    # ── İçecekler ────────────────────────────────────────────────────────────
    (["rode wijn","rode-wijn"],  "D06","Şarap","Kırmızı Şarap",""),
    (["witte wijn","witte-wijn"],"D06","Şarap","Beyaz Şarap",""),
    (["wijn"],                   "D06","Şarap","Kırmızı Şarap",""),
    (["trappist"],               "D06","Bira","Trappist",""),
    (["abdijbier"],              "D06","Bira","Abbij & Dubbel/Tripel",""),
    (["bier"],                   "D06","Bira","Pilsner & Lager",""),
    (["frisdrank"],              "D06","Gazlı İçecek","Kola & Cola",""),
    (["fruitsappen"],            "D06","Meyve Suyu","Uzun Ömürlü",""),
    (["koffie"],                 "D06","Sıcak İçecek","Kahve",""),
    (["thee"],                   "D06","Sıcak İçecek","Çay",""),
    (["water"],                  "D06","Su & Maden Suyu","Maden Suyu",""),
    (["dranken"],                "D06","Su & Maden Suyu","Maden Suyu",""),
    # ── Dondurulmuş ──────────────────────────────────────────────────────────
    (["diepvries","pizza"],      "D07","Dondurulmuş Hazır Yemek","Pizza",""),
    (["diepvries","vis"],        "D07","Dondurulmuş Et & Balık","Dondurulmuş Balık",""),
    (["diepvries","groenten"],   "D07","Dondurulmuş Sebze","Karışık & Tek",""),
    (["diepvries"],              "D07","Dondurulmuş Et & Balık","Dondurulmuş Et",""),
    # ── Atıştırmalık & Şekerleme ─────────────────────────────────────────────
    (["chocolade","praline"],    "D15","Belçika Çikolatası","Pralineler & Kutu Çikolata",""),
    (["chocolade"],              "D08","Çikolata","Tablet Çikolata",""),
    (["koeken","snoep"],         "D08","Şekerleme & Gummy","Şekerleme & Gummy",""),
    (["snoep","koek"],           "D08","Bisküvi & Kek","Belçika Bisküvileri",""),
    (["chips","snacks"],         "D08","Cips & Tuzlu Atıştırmalık","Patates Cipsi",""),
    # ── Kahvaltılık ──────────────────────────────────────────────────────────
    (["ontbijt","granen"],       "D09","Mısır Gevreği","Yetişkin Gevrekleri",""),
    (["ontbijtgranen"],          "D09","Mısır Gevreği","Yetişkin Gevrekleri",""),
    (["beleg"],                  "D09","Reçel & Bal","Reçel",""),
    # ── Hazır Yemek ──────────────────────────────────────────────────────────
    (["koelvers","bereid"],      "D10","Soğutmalı Hazır Yemek","Uluslararası",""),
    (["bereid","maaltijd"],      "D10","Soğutmalı Hazır Yemek","Uluslararası",""),
    # ── Ev Temizliği ─────────────────────────────────────────────────────────
    ...
    (["huisdieren"],             "D14","Köpek","Köpek Maması",""),
    # ── Non-food / Diğer ─────────────────────────────────────────────────────
